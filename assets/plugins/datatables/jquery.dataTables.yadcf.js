...
* omit_default_label
                ...
                Type:               boolean
                Default value:      false
                Description:        Prevent yadcf from adding "default_label" (--Seleccionar-- / --Seleccionar--)
					...
					if ($filter_selector.length === 1) {
						...
						if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
							...
							if (columnObj.filter_type === "select") {
								...
								$(filter_selector_string).append("<select style='border-radius: 4px; font-size: 12px; background-color: white' id=\"yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter " + columnObj.style_class + "\" " +
								...
								$(filter_selector_string).append("<select style='border-radius: 4px; font-size: 12px;' id=\"yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter " + columnObj.style_class + "\" " +
									filterActionStr + " onkeydown=\"yadcf.preventDefaultForEnter(event);\" onmousedown=\"yadcf.stopPropagation(event);\" onclick='yadcf.stopPropagation(event);'>" + column_data + "</select>");
								if (filter_reset_button_text !== false) {
			...
			for (columnsArrIndex = 0; columnsArrIndex < filtersOptions.length; columnsArrIndex++) {
				...
				if (columnsObj.filter_default_label === undefined) {
					if (columnsObj.filter_type === "select" || columnsObj.filter_type === 'custom_func') {
						columnsObj.filter_default_label = "--Seleccionar--";
