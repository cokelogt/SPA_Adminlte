        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                ...
                function checkCaption(exportButton) {
                    ...
                    $caption.length ? $caption.append(exportButton) : $el.prepend('<caption style="display:table-caption" class="' + bootstrapSpacing + self.settings.position + '" >' + exportButton + '</caption>');
                }
