...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            inputClass: 'form-control form-control-sm input-sm',
            ...
            buttons: {
                ...
                restore: {
                    ...
                    html: '<span class="fa fa-history"></span>',
                    action: 'restore'
                },
                confirm: {
                    class: 'btn btn-xs btn-danger',
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        if (settings.editButton && settings.saveButton) {
                            saveButton = '<button type="button" class="tabledit-save-button ' + settings.buttons.save.class + '" style="display: none; float: none; margin-left:5px">' + settings.buttons.save.html + '</button>';
                        }
                        ...
                        $table.find('tr:gt(0)').append('<td style="white-space: nowrap; width: 80px;">' + toolbar + '</td>');
                    }
                }
            }
        };
