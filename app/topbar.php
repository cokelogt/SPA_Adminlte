<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link linker" onclick="loadModule('modules/dashboard/dashboard.php','dash')">Home</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link linker" onclick="loadModule('modules/forms/forms.php','forms')">Forms</a>
        </li>
    </ul>
